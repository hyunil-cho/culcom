    ...
    <div className={s.wrapper}>
      <div className={s.container}>
        ...
        <Section title="5. 정보주체와 법정대리인의 권리/의무 및 행사방법">
          ...
          <ol><li>개인정보 열람요구</li><li>오류 등이 있을 경우 정정 요구</li><li>삭제요구</li><li>처리정지 요구</li></ol>
        </Section>
        ...
        <Section title="7. 개인정보의 파기">
          <p>① 컬컴 점주협의회는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.</p>
          <p>② 컬컴 점주협의회는 다음의 방법으로 개인정보를 파기합니다.</p>
          <ul><li><strong>전자적 파일:</strong> 파일 삭제, 디스크 포맷</li><li><strong>종이 문서:</strong> 분쇄하거나 소각</li></ul>
        </Section>
        ...
        <Section title="8. 개인정보의 안전성 확보조치">
          ...
          <ul>
            ...
            <li><strong>기술적 조치:</strong> 개인정보처리시스템의 비밀번호 설정 등 접근권한 관리, 백신소프트웨어 등 보안프로그램 설치, 개인정보가 저장된 파일의 암호화</li>
        ...
        <Section title="9. 개인정보 자동 수집 장치의 설치 운영 및 그 거부에 관한 사항">
          ...
          <p>② 이용자는 웹 브라우저의 옵션 설정을 통해 쿠키 저장을 거부할 수 있습니다.</p>
        </Section>
